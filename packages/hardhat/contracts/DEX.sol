...
contract DEX {
  ...
  // write your functions here...
    ...
    // function withdrawBalloons(uint256 tokens) payable external {
    //     require(token.balanceOf(address(this)) == tokens,"DEX don't have enough tokens");
    //     require(token.transferFrom(address(this),msg.sender, tokens),"withdrawBalloons Failed");
    // }
}